...
benchmark_performance <- function (test_spots_metadata_mtrx, spot_composition_mtrx) 
{
  ...
  return(list(
    ...
    RMSE = RMSE,
    Sum_RMSE = all_rmse,
    corr = cor.test(test_spots_metadata_mtrx,spot_composition_mtrx,method="pearson"),
    
    kendall=cor.test(test_spots_metadata_mtrx,spot_composition_mtrx,method="kendall"),
    
    spearman=cor.test(test_spots_metadata_mtrx,spot_composition_mtrx,method="spearman")
    #corrss=cor(test_spots_metadata_mtrx,spot_composition_mtrx,method = c("pearson","kendall","spearman"))
  ))
}